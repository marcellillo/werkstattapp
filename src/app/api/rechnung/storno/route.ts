...
export async function POST(req: NextRequest) {
  try {
    ...
    // damit sie in eine neue (korrekte) Rechnung übernommen werden können.
    // Die Rechnung selbst bleibt als Datensatz erhalten (nur storniert), statt gelöscht zu werden.
