...
import { ArrowLeft, Car, User, Plus, Download, RefreshCw } from 'lucide-react'
              ...
              <div className="bg-purple-50 border border-purple-200 rounded-lg p-3">
                ...
                {mobileAds.length === 0 && (
                  <p className="text-xs text-purple-600">
                    Klicke auf <RefreshCw className="w-3 h-3 inline" /> um die ads.json aus Mobile.de hochzuladen
                  </p>
                )}
              </div>
            )}
          ...
          <CardContent className="space-y-3">
            <div>
              ...
              <textarea
                ...
                placeholder="z.B. Bremsen prüfen, Ölverlust am Motor..."
                rows={2}
